...
export class InitHikes1784540562558 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "hikes" ("id" SERIAL NOT NULL, "user_id" integer NOT NULL, "trail_id" integer, "name" character varying NOT NULL, "date" date NOT NULL, "distance_km" double precision NOT NULL, "is_public" boolean NOT NULL DEFAULT true, "note" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_881b1b0345363b62221642c4dcf" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "hike_tracks" ("hike_id" integer NOT NULL, "geom" geometry(LineString,4326) NOT NULL, CONSTRAINT "PK_de48e81cc25f2351bf8f70f9a85" PRIMARY KEY ("hike_id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "hikes" ADD CONSTRAINT "FK_761d26c0878d1668effa3aa2c09" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "hike_tracks" ADD CONSTRAINT "FK_de48e81cc25f2351bf8f70f9a85" FOREIGN KEY ("hike_id") REFERENCES "hikes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
