...
export const PanelProvider = ({ children }: { children: ReactNode }) => {
    ...
    // 把這些 state 綁定到 PanelContext.Provider 上，這樣被包住的所有 component 就都能使用了
    return <PanelContext.Provider value={{ hoverFeatureId, setHoverFeatureId, activeFeatureId, setActiveFeatureId }}>{children}</PanelContext.Provider>;
};

// 自定義 hook usePanel()，讓你在 component 裡可以用得像 useState 一樣直覺。
